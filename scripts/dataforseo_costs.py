...
Config: ~/.config/seoflow/dataforseo-costs.json
Ledger: ~/.config/seoflow/dataforseo-ledger.json
...
Security fixes: config path corrected to ~/.config/seoflow/
"""
...
# ----- paths -----
CONFIG_DIR = Path.home() / ".config" / "seoflow"
