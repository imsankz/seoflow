...
- Fetch the target URL using `python3 .seoflow/scripts/render_page.py "<url>" --mode auto --json` (SPA-aware SSRF-protected renderer)
- Parse with `python3 .seoflow/scripts/parse_html.py "<url>"` to extract SEO elements
