...
- `python3 .seoflow/scripts/drift_baseline.py <url>` -- capture a new baseline
- `python3 .seoflow/scripts/drift_compare.py <url>` -- compare current state to baseline
- `python3 .seoflow/scripts/drift_history.py <url>` -- show change history
- `python3 .seoflow/scripts/drift_report.py <file> --output report.html` -- generate HTML report
