...
```
~/.cache/seoflow/drift/baselines.db
```
...
**Execution:**
```bash
python3 .seoflow/scripts/drift_baseline.py <url>
python3 .seoflow/scripts/drift_baseline.py <url> --skip-cwv
```
...
**Execution:**
```bash
python3 .seoflow/scripts/drift_compare.py <url>
python3 .seoflow/scripts/drift_compare.py <url> --baseline-id 5
python3 .seoflow/scripts/drift_compare.py <url> --skip-cwv
```
...
```bash
python3 .seoflow/scripts/drift_report.py <comparison_json_file> --output drift-report.html
```
...
**Execution:**
```bash
python3 .seoflow/scripts/drift_history.py <url>
python3 .seoflow/scripts/drift_history.py <url> --limit 10
```
