...
3. If Google API credentials detected (`python3 .seoflow/scripts/google_auth.py --check`), also spawn seo-google agent
...
6. If backlink APIs detected (`python3 .seoflow/scripts/backlinks_auth.py --check`), also spawn seo-backlinks agent
...
10. If drift baseline exists for this URL (`python3 .seoflow/scripts/drift_history.py <url>`), also spawn seo-drift agent
