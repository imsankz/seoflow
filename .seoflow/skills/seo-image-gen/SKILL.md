...
```bash
python3 .seoflow/scripts/presets.py list
```
...
- Log every generation: `python3 .seoflow/scripts/cost_tracker.py log --model MODEL --resolution RES --prompt "brief"`
...
| MCP unavailable | Fall back: `python3 .seoflow/scripts/generate.py --prompt "..." --aspect-ratio "16:9"` |
