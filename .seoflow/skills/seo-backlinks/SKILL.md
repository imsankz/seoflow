...
2. **Moz API** (free signup): `python3 .seoflow/scripts/backlinks_auth.py --check moz --json`
3. **Bing Webmaster** (free signup): `python3 .seoflow/scripts/backlinks_auth.py --check bing --json`
...
Run `python3 .seoflow/scripts/backlinks_auth.py --check --json` to detect all sources at once.
...
**Moz API:** `python3 .seoflow/scripts/moz_api.py metrics <url> --json` → Domain Authority, Page Authority, Spam Score, linking root domains, external links.

**Common Crawl:** `python3 .seoflow/scripts/commoncrawl_graph.py <domain> --json` → in-degree (referring domain count), PageRank, harmonic centrality.
...
**Moz API:** `python3 .seoflow/scripts/moz_api.py anchors <url> --json`

**Bing Webmaster:** `python3 .seoflow/scripts/bing_webmaster.py links <url> --json` (extract anchor text from link details)
...
**Moz API:** `python3 .seoflow/scripts/moz_api.py domains <url> --json` → domains with DA scores

**Common Crawl:** `python3 .seoflow/scripts/commoncrawl_graph.py <domain> --json` → top referring domains (domain-level, no authority scores)
...
**Moz API:** Spam Score from `python3 .seoflow/scripts/moz_api.py metrics <url> --json` (1-17% scale, >11% = high risk)

**Verification Crawler:** `python3 .seoflow/scripts/verify_backlinks.py --target <url> --links <file> --json` (verify suspicious links still exist)
...
**Moz API:** `python3 .seoflow/scripts/moz_api.py pages <domain> --json`
...
**Bing Webmaster (unique!):** `python3 .seoflow/scripts/bing_webmaster.py compare <url1> <url2> --json` — the only free tool with built-in competitor comparison

**Moz API:** Compare DA/PA between domains via `python3 .seoflow/scripts/moz_api.py metrics <url> --json` for each
...
**Verification Crawler:** For known links, verify current status with `python3 .seoflow/scripts/verify_backlinks.py`
