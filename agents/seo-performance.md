...
2. Use `python3 .seoflow/scripts/render_page.py <URL> --mode auto --json` before HTML/source inspection so SPA content is visible when needed
...
python3 .seoflow/scripts/pagespeed_check.py URL --json

# SPA-aware HTML/render inspection
python3 .seoflow/scripts/render_page.py URL --mode auto --json
...
```bash
python3 .seoflow/scripts/pagespeed_check.py URL --json
python3 .seoflow/scripts/crux_history.py URL --json
```
